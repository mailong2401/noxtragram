            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Nhập số di động có thể dùng để liên hệ với bạn. Sẽ không ai nhìn '
                  ...
                  const Text(
                    'Chúng tôi có thể gửi cho bạn thông báo qua SMS và WhatsApp nhằm '
                        'mục đích bảo mật và đăng nhập.',
                    style: TextStyle(
                        color: Colors.grey,
                        fontSize: 15,
                        fontWeight: FontWeight.normal),
